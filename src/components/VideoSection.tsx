...
export default function VideoSection() {
  ...
  const videoUrl = 'https://upload.wikimedia.org/wikipedia/commons/5/59/Meet_the_Capacity_Exchange.webm';
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[84%] h-[100%]">
                {darkMode ? (
                  ...
                  <Image
                    src={VideoThumbnail}
                    alt={pageContent["alt-video-thumbnail"] || "Video thumbnail showing CapX introduction"}
          ...
          <Popup onClose={handleClosePopup} title={pageContent['body-home-video-section-title']}>
            <div className="w-full h-full relative">
              <video
                ...
                playsInline
                preload="metadata"
                aria-label={pageContent["aria-label-video-player"] || "Capacity Exchange introduction video"}
                muted={false}
              ...
              >
                ...
                <p className="text-sm text-gray-600 mt-2">
                  {pageContent["video-fallback-message"] || "Your browser does not support the video tag. Please use a modern browser to view this video."}
                </p>
              </video>
              ...
              <div className="mt-4 flex justify-center">
                <BaseButton
                  ...
                  aria-label={pageContent["aria-label-toggle-transcript"] || "Toggle video transcript"}
                />
              </div>

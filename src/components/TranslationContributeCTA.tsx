...
interface HelpIconProps {
  ...
  setShowHelpPopup: (value: boolean) => void;
      ...
      {showHelpPopup && (
        ...
        >
          ...
          <button
            ...
            className={`mt-2 text-xs font-medium ${darkMode ? 'text-blue-300' : 'text-blue-600'}`}
          >
...
function DesktopHelpIcon({
  darkMode,
  helpText,
  pageContent,
}: Pick<HelpIconProps, 'darkMode' | 'helpText' | 'pageContent'>) {
  return (
...
function HelpIcon({ isMobile, ...rest }: HelpIconProps) {
  return (
    ...
    >
      {isMobile ? (
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          />
          <div
            className={`text-capx-text-xs ${darkMode ? 'text-blue-200' : 'text-capx-dark-box-bg'}`}
          >
            {pageContent['translation-contribute-compact'] ||
              "Don't see this capacity in your selected language? Help us translate it on Metabase!"}
            {helpIcon}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-left">
              <span
                className={`inline-flex items-center gap-1 text-xs ${darkMode ? 'text-blue-300' : 'text-blue-600'}`}
              >
                {pageContent['translation-contribute-link'] || 'Contribute'}
                <svg
...
export function TranslationContributeCTA({
  ...
  return compact ? <CompactCTA {...viewProps} /> : <FullCTA {...viewProps} />;
}

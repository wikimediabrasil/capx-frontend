...
describe('MobileMenuLinks', () => {
  ...
  it('renders menu links when logged in', () => {
    ...
    renderWithProviders(
      <MobileMenuLinks session={validSession} handleMenuStatus={handleMenuStatus} />
    );
  ...
  it('renders organization profiles for org managers', async () => {
    renderWithProviders(<MobileMenuLinks session={validSession} handleMenuStatus={jest.fn()} />);

...
describe("MainSection", () => {
  const mockPageContent = {
    ...
    "body-home-section01-description": "Berhubung dengan rekan sejawat, belajar, dan berbagi keterampilan dalam platform yang dibuat untuk dan oleh Gerakan Wikimedia.",
  ...
  it("maintains layout structure with long text", () => {
    const longContent = {
      ...mockPageContent,
      "body-home-section01-title-text": "Sebuah ruang untuk saling bertukar pengalaman dan pengetahuan",
      "body-home-section01-description": "Berhubung dengan rekan sejawat, belajar, dan berbagi keterampilan dalam platform yang dibuat untuk dan oleh Gerakan Wikimedia. Kami mendorong kolaborasi dan pertukaran pengetahuan antar komunitas."
    };

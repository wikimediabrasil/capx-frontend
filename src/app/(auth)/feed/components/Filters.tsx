            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                <CheckboxButton
                  ...
                  checked={
                    filters.profileCapacityTypes?.includes(
                      ProfileCapacityType.Learner
                    ) ?? false
                  }
                  onClick={() =>
                    handleProfileCapacityTypeToggle(ProfileCapacityType.Learner)
                  }
                />
                <CheckboxButton
                  icon={SharerIcon}
                  ...
                  onClick={() =>
                    handleProfileCapacityTypeToggle(ProfileCapacityType.Sharer)
                  }
                />
              </div>
            </div>

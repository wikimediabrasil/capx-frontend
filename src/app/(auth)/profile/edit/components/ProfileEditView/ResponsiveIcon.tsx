...
import { getThemedIcon, getResponsiveSize } from './utils';
...
export function ResponsiveIcon({
  ...
  const icon = getThemedIcon(lightIcon, darkIcon, darkMode);
  const size = getResponsiveSize(mobileSize, desktopSize, isMobile);

...
export default function CardRecomendationCarousel({ alt = '', title, description,imageTitle, imageDescription, mainImage, imageName, name, labelButtonPrimary, labelButtonSecondary }: CardRecomendationCarouselProps) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-start items-start bg-[#FFFFFF] p-4 mx-auto rounded-md w-[270px] md:w-[370px]">
        ...
        <div className="flex items-center justify-start gap-2 bg-red-500 md:h-[65px]">
          TEST
        </div>
        <div className= 'flex items-center justify-start gap-2'>
          <BaseButton

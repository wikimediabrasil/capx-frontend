...
export default function PrivacyPolicyPage() {
  ...
  const capacityExchangeText =
    pageContent["privacy-policy-capacity-exchange-text"]?.split(/\$\d/);
  const privateInformationTopic =
    pageContent["privacy-policy-private-information-topic02"]?.split(/\$\d/);
  const privateInformationText =
    pageContent["privacy-policy-private-information-text03"]?.split(/\$\d/);

  return (
    <section className="w-full flex flex-col min-h-screen mx-auto px-4 gap-4 pt-24 md:pt-8 mx-4 md:max-w-[1200px]">
      <Banner
        image={PrivacyPolicy}
      ...
      <div className="flex flex-col items-start gap-2 text-left pt-6">
        ...
        <div className="flex flex-col items-start text-left pl-5">
          <p
            className={`relative font-[Montserrat] text-[12px] not-italic font-normal leading-[2] mb-4 pl-2 md:text-[20px] md:leading-[29px]  ${
              darkMode ? "text-white" : "text-capx-dark-box-bg"
            }`}
          >
        ...
        <div className="flex items-start text-left">
          <p
            className={`font-[Montserrat] text-[12px] not-italic font-normal leading-[2] mb-4 md:leading-[29px] md:text-[20px] ${
              darkMode ? "text-white" : "text-capx-dark-box-bg"
            }`}
          >

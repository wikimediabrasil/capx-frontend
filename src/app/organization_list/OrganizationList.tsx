...
import { createProfilesFromOrganizations, FilterState, ProfileCapacityType, ProfileFilterType, Skill } from "@/app/(auth)/feed/types";
...
export default function OrganizationList() {
  ...
  const totalRecords = (activeFilters.profileCapacityTypes.includes(ProfileCapacityType.Learner) ? 
